...
class Product with ChangeNotifier {
  ...
  Product({@required this.id, @required this.title, @required this.imgUrl, @required this.description, @required this.rating, @required this.price, this.isFavorite = false});

  @override
  String toString() {
    return {"id": id, "title": title, "imgUrl": imgUrl, "description": description, "price": price, "rating": rating, "isFavorite": isFavorite}.toString();
  }
...
class Products extends ChangeNotifier {
  ...
  List<Product> get favorites => _items.where((prod) => prod.isFavorite).toList();

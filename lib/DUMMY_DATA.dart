...
final List<Product> DUMMY_DATA = [
  Product(
    ...
    rating: 4.2,
    price: 28.25,
    imgUrl: "https://www.thermofisher.com/blog/wp-content/uploads/2014/08/tomatoes.jpg",
    description:
        "Tomatoes are the major dietary source of the antioxidant lycopene, which has been linked to many health benefits, including reduced risk of heart disease and cancer. They are also a great source of vitamin C, potassium, folate, and vitamin K.",
    blurHash: ':wRUdZjYyrRkyDtQo}s:tRo}WVVsniW;jFniy?aeVst7i^WVVsWBspnin%aeSLofX7X8yDX8VsoLRjjGkCfiR*V@a{kWj[n%ofofW;kCWBayoMV[j]j[a|aKj[o}oLaefPjZ',
  ),
  Product(
    ...
    rating: 4,
    price: 22.50,
    imgUrl: "https://www.mr-fruity.co.uk/wp-content/uploads/2019/04/potato-04.jpg",
    blurHash: ':nQJ4JWZ.9s*tSj]xuj?%NtRjrM{WBofaeWB.TkCWAV@V?ogRPafWARPRQtRt7WCj]ozxujrV?bca}jsofj[RjWBt7ozj]aeaxWBogjsWAkCj[aeayaeofflf7jsaxWBj[jt',
    description:
  ...
  Product(
    ...
    rating: 3,
    price: 266.30,
    imgUrl: "https://tbrnewsmedia.com/wp-content/uploads/2020/10/Acorn-Squash-scaled.jpg",
    blurHash: ':vOy;JxuyENe.8j?kWt6s;ofWBj?ofbIR*WB.TRjnhoJM{jsRPWCbcbHa}WBayjFoLs.x]bHRit6RjWEt7s:oLaxj[a#WAj@kCbbxZj[WBWCjsj[ogayWVWBkCofaebHofWV',
    description:
  ...
  Product(
    ...
    rating: 5,
    price: 42.00,
    imgUrl: "https://post.healthline.com/wp-content/uploads/2020/09/AN172-Beets-732x549-Thumb_0.jpg",
    blurHash: ':EG@rqy=.l\$*5kAUD+%L+%ko\$fS}R\$NsM{oyFxELIBIn-9M{xBNGwGJ#tMr{a%oxRRouo{Sxxo=|ohS\$M}S1InNHEL%2-Vt4xuR*WExGIoIpn+X8xt%1-ooLs:R%RiRkELod',
    description:
  ...
  Product(
    ...
    rating: 4,
    price: 348.50,
    imgUrl: "https://post.medicalnewstoday.com/wp-content/uploads/sites/3/2020/02/266425_2200-732x549.jpg",
    blurHash: ':hI~P2o\$~WxZt8odWEt7??jvVuWURQjbs;ogxabXRRR\$NFbFobof-Xo#j_jFWTWBWAe=NGxIWAa#WSoebFj@n.oMs:WBWAjbWBa#xIk8oyaxj?RkWBj]ogt5s:ofoMofWDaf',
    description:
  ...
  Product(
    ...
    rating: 4,
    price: 48.60,
    imgUrl: "https://www.almanac.com/sites/default/files/styles/primary_image_in_article/public/image_nodes/carrots-table_popidar-ss.jpg?itok=lh-pzqm3",
    blurHash: ':9IL}L041z}A5pO9RS%0B3N3OT\$*niOU-B\$z1M]U=aoM#-XQ\$PNbSv#qxDs:sAOBNdI=\$%sV}Y5,9^NbSfi|xDJ8oLADJ8}Y\$\$r]J7NbJAae-9=dS2R-S1\$i\$jsmj[Wp9]Eg',
    description:
  ...
  Product(
    ...
    rating: 4,
    price: 35.20,
    imgUrl: "https://snaped.fns.usda.gov/sites/default/files/seasonal-produce/2018-05/cucumbers2.jpg",
    blurHash: ':LKL4|00}eSasqs;oZxvEh4ojER\$WFofodoNQ_Ioo@ogIoaxRkRjOURie=xvxtWUjaax?bt5R%ajV?t7RRWB%MbFxaRjNZjbS2ozt7V@IUaejYkV%LWUV]RktQxuRkj]V@WU',
    description:
  ...
  Product(
    ...
    rating: 3,
    price: 32.30,
    imgUrl: "https://organicfoodshare.com.au/wp-content/uploads/D7DEEEED-9684-4B08-88C0-FF90B258A023-600x600.jpeg",
    blurHash: ':pPr:*xt?^M{x]oyjGt8%gbHR%aKafo#V@js.SbIaMRkRPoKRjV@RQozRjWBt7ofofWBozayV?xtWVR*ofaej=V@ogR*ofoJWBofozRjWBoyayogofkCWBt7flozjZRjWBWB',
    description:
  ...
  Product(
    ...
    blurHash: ':ELp~X~V00--MzWAs:i_00x@yESJt7R+oLof009s_2XTtQxuW?bb.AE2i]xvM|xtM|S1iw%3W?i^t7RjbHR,-qnlIBWVs:S#s:ofaKe.R:R+Rkoyaet7W:ShWBbcR*jXozRk',
    description:
  ...
  Product(
    ...
    rating: 5,
    price: 75.00,
    imgUrl: "https://5.imimg.com/data5/TQ/MB/VF/SELLER-3722283/cabbage-500x500.jpg",
    blurHash: ':tQJ+8oy?Jf7a\$j?bGayxuayf9juWAj[ayaz?dWBM_j[awa|ayofRij[R%fiogazs;fks=j[R\$ayj]oLj]WBRma}xuazjcayR%jsWTaya#j[oMa#j@j@xaj@R%ayWBj[a{fR',
    description:
  ...
  Product(
    ...
    blurHash: ':rPPfnt8_NaKb]Rjxuozs:ofbbR%V@oLoLbH?^RiM{t8eos;M{WBR%WBs:oMkCbGRjjZ%Mt7M_WBaeayofjZoybFV[oMofbHj[ayjuoMaeRjoybHoLkCt7ayWBayofjaj[kC',
    description:
  ...
  Product(
    ...
    rating: 5,
    price: 46.20,
    imgUrl: "https://i1.wp.com/www.eatthis.com/wp-content/uploads//media/images/ext/407850298/whole-cauliflower.jpg?fit=1024%2C750&ssl=1",
    blurHash: ':KE.;3M{4V^*R%ELRkxa~pE29ZxuR%j[s;axDjt7tPIooznms;W-My%LxtM{t7ahoeoLIVofxtRQj[xtoLaeM|R%oxa\$s:s:Rkayahj?t6f8aeoLWBWVt7ofoeWCV[oeWVof',
    description:
  ...
  Product(
    ...
    rating: 2,
    price: 200.00,
    imgUrl: "https://snaped.fns.usda.gov/sites/default/files/styles/crop_ratio_7_5/public/seasonal-produce/2018-05/mushrooms.jpg?h=b754914e&itok=Kldbq8Du",
    blurHash: ':OI4^aaeIoW=M|ayoLRj~pRjRjkCR*fQWBofIoWVRkayaxj[ogt7WBxubHWBRjRjxuj[t6t7t7fRNGM{ofoeflWBRjofj[oeWBfPozRjRjt7WBj]s:jsxuayRjofofoeaybH',
    description:
  ...
  Product(
    ...
    rating: 4,
    price: 78.20,
    imgUrl: "https://solidstarts.com/wp-content/uploads/Broccoli_edited-480x320.jpg",
    blurHash: ':eLX#h%g^-oLnVahS0j]9GafRQWTt5V]WBt6xdoMITbHW,bEoMWBIUoykBoMV_t6oeV[%4M{k9bFaxoNjuofM{t6ofogagaya#axxbf6R%f8oLfijbfPa#axt7agWBaxkBWC',
    description:
  ...
  Product(
    ...
    rating: 3,
    price: 52.00,
    imgUrl: "https://www.mayoclinichealthsystem.org/-/media/national-files/images/hometown-health/2018/corn.jpg",
    blurHash: ':TJ@BA%JE7RmIroLRkRR~RxpaiNIM|a}t6R+E7xV-mkBf6ofoeR+-ntOt5jcR-j[RkV[\$~ayt7Irsl\$~oyxsbIRkRlWC-mt5kBbH%0R*Rl%0j[NdoKRkt5Rks.oyNHWEs:oe',
    description:
  ...
  Product(
    ...
    rating: 3,
    price: 54.20,
    imgUrl: "https://images.herzindagi.info/image/2019/Feb/tasty-karela-recipe-main.jpg",
    blurHash: ':CAw|Q.i?H%enAVcR8nS%wb;xar]RRaMV[RkuuR7IWMMNGR*X4kTMzVbRkaMafbrtPkByUV^SKtitPoytQtQQ@oLbFpEtio{oys:Q;V[bYRkafoeW.V]VuVvo{ayafaMafaf',
    description:
  ...
  Product(
    ...
    rating: 5,
    price: 38.45,
    imgUrl: "https://im.indiatimes.in/content/2014/Oct/1739119_1437679123.jpg",
    blurHash: ':vP7dp%3-rohxcR%xbR%ogs=NEbDoMj[oNWB^-RjNFofRibEWBj[xbWma\$Rkk9aya{ofn-WVf#j=WVoMfRj]W,Rjxbt8WUoNR%ayWTaxjcWBofa#axoMWBj=ogR*ayoeoeaz',
    description:
  ...
  Product(
    ...
    blurHash: ':sO|X?WC?c%2%MWCogWBkCofs:WBRjazjbWB~qoJIUM|M{ofRjof%2M|M{t7t7oeofofogofWAoeRjaxtQWBRjt7ofRjt7WBRjWCRjWUaxj[xbafWBoffiWBt7jtV[j]ayof',
    description:
  ...
  Product(
    ...
    rating: 5,
    price: 135.85,
    imgUrl: "https://draxe.com/wp-content/uploads/2017/01/RawGarlicBenefitsThumbnail.jpg",
    blurHash: ':9Hx7{\$dDjH=004onhOF1P4:t7NGM{%1RjoL009Z_4-=?vkqt6jE00~pR\$IUxuWFX9D%.9bc8_xHs9xaxu-ps+R5RQ%h%MbcV@%g\${^,JUM^R.adD%WETL9^\$%V?D%M_t6Rj',
    description:
